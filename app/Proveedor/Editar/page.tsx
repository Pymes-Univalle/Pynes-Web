...
export default function Editar() {
  ...
  return (
    <div className="bg-blanco h-full w-full text-black ">
        ...
        <form className=" p-5 border-1 shadow " onSubmit={handleSubmit}>
          ...
          <div className="mb-5 mt-5">
            <Input
              ...
              errorMessage={
                validationNombre === "invalid" &&
                "El campo nombre es obligatorio y solo letras"
              }
          ...
          <div className="mb-5">
            <Input
              ...
              errorMessage={
                validationCelular === "invalid" &&
                "El campo nombre es obligatorio y solo numeros"
              }
