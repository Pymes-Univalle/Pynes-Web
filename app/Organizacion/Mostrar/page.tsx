        ...
        <TableBody items={items}>
          {(item) => (
            <TableRow key={item["id"]}>
              ...
              <TableCell>{item["organizacion"] ? item["organizacion"]["latitud"] : 'No disponible'}</TableCell>
              <TableCell>{item["organizacion"] ? item["organizacion"]["longitud"] : 'No disponible'}</TableCell>
              <TableCell>{item["organizacion"] ? item["organizacion"]["crearProductos"] : 'No disponible'}</TableCell>
              <TableCell>{item["organizacion"] ? item["organizacion"]["nit"] : 'No disponible'}</TableCell>
              <TableCell>
                <Button
