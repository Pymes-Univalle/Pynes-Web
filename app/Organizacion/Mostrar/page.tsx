  ...
  return (
    <div className="text-white p-4 h-full w-full max-w-7xl flex-col items-center justify-center">
      ...
      <Link
        ...
        className="btn bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-8"
      >
        Crear Organizacion
      </Link>
      <Table
        ...
        <TableBody items={items}>
          {(item) => (
            <TableRow key={item["id"]}>
              ...
              <TableCell>{item["organizacion"] ? item["organizacion"]["latitud"] : 'N/A'}</TableCell>
              <TableCell>{item["organizacion"] ? item["organizacion"]["longitud"] : 'N/A'}</TableCell>
              <TableCell>{item["organizacion"] ? item["organizacion"]["crearProductos"] : 'N/A'}</TableCell>
              <TableCell>{item["organizacion"] ? item["organizacion"]["nit"] : 'N/A'}</TableCell>
              <TableCell>
                <Button
